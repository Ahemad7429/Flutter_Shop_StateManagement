...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    _offSetAnimation = Tween<Offset>(begin: Offset(0, -1.5), end: Offset(0, 0))
        .animate(CurvedAnimation(
    ...
    /// Below line is used to update screen whenever animation happens.
  ...
  void _submit() async {
    ...
    try {
      ...
      var errorMsg = 'Athentication failed';
